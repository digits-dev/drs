...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="get" class="pull-right" style="display:inline-block;width: 260px;"
                        action="{{ route('digits-sales.detail', $item->id) }}">
            ...
            <div class="col-md-12">
                {{ $digits_sales->links() }}
                <p>Showing {{ $digits_sales->firstItem() ?? 0 }} to {{ $digits_sales->lastItem() ?? 0 }} of {{ $digits_sales->total() }} items.</p>        
            </div>
        </div>
