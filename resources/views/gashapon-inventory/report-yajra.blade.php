...
<div class='modal fade' tabindex='-1' role='dialog' id='modal-sales-export'>
    <div class='modal-dialog'>
        <div class='modal-content'>
            ...
            <form method='post' target='_blank' action="{{ route('supplier-intransit-inventory.export') }}" autocomplete="off">
...
<div class='modal fade' tabindex='-1' role='dialog' id='export-filtered-report'>
    <div class='modal-dialog'>
        ...
        <form method='post' target='_blank' action="{{ route('gashapon-inventory.export') }}">
            <input type='hidden' name='_token' value="{{ csrf_token()}}">
...
@push('bottom')
    <script>
        $(document).ready(function(){
            ...
            function load_data(start_date = '', end_date = '', channel_id = '', concept_id = '', receipt_number = '') {
                $('#sales-report-table').DataTable({
                    ...
                    ajax: {
                        url: '{{ route("gashapon-inventory.filter") }}',
                        data: {
                            datefrom: start_date,
                            dateto: end_date
                        },
        ...
        $('#exportBtn').click(function(e) {
            ...
            $('.progress-div').show();
            $.ajax({
                url: '{{ route("gashapon-inventory.export") }}',
                type: 'POST',
