...
class ExportWarehouseInventoryCreateFileJob implements ShouldQueue
{
    ...
    public function handle(){
        ...
        (new \Rap2hpoutre\FastExcel\FastExcel($this->salesGenerator($warehouseInventory)))
            ->export(storage_path("app/{$this->folder}/ExportWarehouseInventory.csv"), function ($sale) {
                $salesReport = [];
                $salesReportCon = [];
