...
class ProcessGashaponStoreSalesUploadJob implements ShouldQueue
{
    ...
    public function __construct($args)
    {
        ...
        $store_sales_upload = GashaponStoreSalesUpload::create([
    ...
    public function handle()
    {
        ...
        $excel_data = Excel::toArray(new GashaponStoreSalesImport($this->batch_number), $this->excel_path)[0];
        ...
        $store_sales_upload = GashaponStoreSalesUpload::find($this->store_sales_uploads_id);
        ...
        foreach ($chunks as $key => $chunk) {
            ...
            $store_sales_upload_line = new GashaponStoreSalesUploadLine([
            ...
            $batch->add(new GashaponStoreSalesImportJob($store_sales_upload_line->id));
        }
