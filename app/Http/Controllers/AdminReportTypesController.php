<?php namespace App\Http\Controllers;
	...
	class AdminReportTypesController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "report_type";
			$this->limit = "20";
			$this->orderby = "report_type,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Report Type","name"=>"report_type"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Report Type','name'=>'report_type','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-6'];
