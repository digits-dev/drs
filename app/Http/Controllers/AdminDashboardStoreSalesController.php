<?php namespace App\Http\Controllers;
	...
	class AdminDashboardStoreSalesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Is Valid","name"=>"is_valid"];
			$this->col[] = ["label"=>"Is Final","name"=>"is_final"];
			$this->col[] = ["label"=>"Rr Flag","name"=>"rr_flag"];
			$this->col[] = ["label"=>"Rr Flag Temp","name"=>"rr_flag_temp"];
			...
			$this->form[] = ['label'=>'Employees Id','name'=>'employees_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'employees,first_name'];
			$this->form[] = ['label'=>'Customers Id','name'=>'customers_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'customers,trade_name'];
			...
			//$this->form[] = ["label"=>"Employees Id","name"=>"employees_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"employees,first_name"];
			//$this->form[] = ["label"=>"Customers Id","name"=>"customers_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"customers,trade_name"];
