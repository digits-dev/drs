<?php namespace App\Http\Controllers;
	...
	class AdminDigitsSalesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Systems Id","name"=>"systems_id","join"=>"systems,system_name"];
			$this->col[] = ["label"=>"Organizations Id","name"=>"organizations_id","join"=>"organizations,organization_name"];
