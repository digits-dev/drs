<?php namespace App\Http\Controllers;
	...
	class AdminSystemsController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "system_name";
			$this->limit = "20";
			$this->orderby = "system_name,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"System Name","name"=>"system_name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'System Name','name'=>'system_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-6'];
