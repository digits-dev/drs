<?php namespace App\Http\Controllers;
	...
	class AdminAnnouncementsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Message','name'=>'message','type'=>'wysiwyg','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
	    ...
	    */
		...
		public function getUnreadAnnouncements(){
			...
			$data['unreadAnnouncements'] = Announcement::whereDoesntHave('users', function($query) use ($user) {
