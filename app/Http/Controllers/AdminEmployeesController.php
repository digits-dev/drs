<?php namespace App\Http\Controllers;
	...
	class AdminEmployeesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->limit = "20";
			$this->orderby = "employee_name,asc";
			...
			$this->form[] = ['label'=>'First Name','name'=>'first_name','type'=>'text','validation'=>'required|min:1|max:50','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Last Name','name'=>'last_name','type'=>'text','validation'=>'required|min:1|max:50','width'=>'col-sm-6'];
			// $this->form[] = ['label'=>'Employee Name','name'=>'employee_name','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-6'];
			// $this->form[] = ['label'=>'Bill To','name'=>'bill_to','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-6'];
			...
			<div class='modal fade' tabindex='-1' role='dialog' id='modal-export'>
				<div class='modal-dialog'>
					<div class='modal-content'>
						...
						<form method='post' target='_blank' action=".route('employees_export').">
