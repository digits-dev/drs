<?php namespace App\Http\Controllers;
	...
	class AdminCustomersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Concept","name"=>"concepts_id","join"=>"concepts,concept_name"];
			$this->col[] = ["label"=>"Customer Bill To","name"=>"customer_bill_to"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Channel','name'=>'channels_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-6','datatable'=>'channels,channel_name'];
			$this->form[] = ['label'=>'Concept','name'=>'concepts_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-6','datatable'=>'concepts,concept_name'];
			// $this->form[] = ['label'=>'Trade Name','name'=>'trade_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-6'];
			// $this->form[] = ['label'=>'Mall','name'=>'mall','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-6'];
			// $this->form[] = ['label'=>'Branch','name'=>'branch','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Customer Bill To','name'=>'customer_bill_to','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Customer Name','name'=>'customer_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-6'];
