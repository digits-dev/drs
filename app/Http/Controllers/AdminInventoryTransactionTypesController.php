<?php namespace App\Http\Controllers;
	...
	class AdminInventoryTransactionTypesController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "inventory_transaction_type";
			$this->limit = "20";
			$this->orderby = "inventory_transaction_type,asc";
			...
			$this->table = "inventory_transaction_types";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Inventory Transaction Type","name"=>"inventory_transaction_type"];
