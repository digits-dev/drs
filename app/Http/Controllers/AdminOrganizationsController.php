<?php namespace App\Http\Controllers;
	...
	class AdminOrganizationsController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "organization_name";
			$this->limit = "20";
			$this->orderby = "organization_name,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Organization Name","name"=>"organization_name"];
