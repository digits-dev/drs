<?php namespace App\Http\Controllers;
	...
	class AdminConceptsController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "concept_name";
			$this->limit = "20";
			$this->orderby = "concept_name,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Concept Name","name"=>"concept_name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Concept Name','name'=>'concept_name','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-6'];
