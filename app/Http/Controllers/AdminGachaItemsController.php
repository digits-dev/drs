<?php namespace App\Http\Controllers;
	...
	class AdminGachaItemsController extends \crocodicstudio\crudbooster\controllers\CBController {
	        ...
	        */
			...
			if (CRUDBooster::getCurrentMethod() == 'getIndex') {
				...
				if(CRUDBooster::isSuperAdmin()){
					$this->index_button[] = ["label"=>"Upload Data","icon"=>"fa fa-upload","url"=>CRUDBooster::mainpath('gacha-items-upload'),'color'=>'primary'];
				}
			}
			...
			<div class='modal fade' tabindex='-1' role='dialog' id='modal-export'>
				<div class='modal-dialog'>
					<div class='modal-content'>
						...
						<form method='post' target='_blank' action=".route('gacha_imfs_export').">
	    ...
	    */
		...
		public function importData() {
			...
			return view('import.gacha-items-upload', $data)->render();
		}

		public function importItemsTemplate(){
			$filename = "gacha-items"."-".date("Ymd").".csv";
		...
		public function importPostSave(Request $request) {
			...
			Excel::import(new GachaItemsImport, $path);	
		...
		public function getDimfsGachaItemsData(){
			...
			foreach ($all_items as $item) {
				...
				$to_be_inserted['vendor_name']                 = $item['vendor_group_description'];
