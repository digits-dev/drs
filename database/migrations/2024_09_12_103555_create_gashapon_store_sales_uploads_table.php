...
class CreateGashaponStoreSalesUploadsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gashapon_store_sales_uploads', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('gashapon_store_sales_uploads');
    }
}
