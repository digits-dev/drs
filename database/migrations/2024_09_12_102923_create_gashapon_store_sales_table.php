...
class CreateGashaponStoreSalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gashapon_store_sales', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('sales_year')->length(10)->unsigned()->nullable();
            $table->integer('sales_month')->length(10)->unsigned()->nullable();
    ...
    {
        Schema::dropIfExists('gashapon_store_sales');
    }
}
