...
class CreateSupplierIntransitInventoryUploadsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('supplier_intransit_inventory_uploads', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('supplier_intransit_inventory_uploads');
    }
}
