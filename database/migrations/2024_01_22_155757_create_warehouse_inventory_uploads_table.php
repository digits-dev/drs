...
class CreateWarehouseInventoryUploadsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('warehouse_inventory_uploads', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('warehouse_inventory_uploads');
    }
}
