...
class CreateDigitsSalesUploadsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('digits_sales_uploads', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('digits_sales_uploads');
    }
}
